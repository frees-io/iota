...
final class CopQ[LL <: TListQ, E, Z[_], F[_], A] private[iota](
  val index: Int,
  val value: Any
) {
  type L = LL
...
object CopQ {
  ...
  def unsafeApply[L <: TListQ, E, Z[_], F[_], A](index: Int, fa: Z[A]): CopQ[L, E, Z, F, A] =
  ...
  /** A type class witnessing the ability to inject type constructor `T[_, _[_], _[_], _]`
    * into a coproduct of types constructors for [[TListQ]] type `L`
    */
  final class InjectL[T[_, _[_], _[_], _], L <: TListQ] private[InjectL](index: Int) {
  ...
  object InjectL {
    def apply[T[_, _[_], _[_], _], L <: TListQ](implicit ev: InjectL[T, L]): InjectL[T, L] = ev
    implicit def makeInjectL[T[_, _[_], _[_], _], L <: TListQ](implicit ev: TListQ.Pos[L, T]): InjectL[T, L] =
